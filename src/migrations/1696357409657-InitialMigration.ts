...
export class InitialMigration1696357409657 implements MigrationInterface {
    name = 'InitialMigration1696357409657'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "email" character varying(50) NOT NULL, "cpf" integer NOT NULL, "tel" character varying(100) NOT NULL, "birth" date NOT NULL, "password" character varying(50) NOT NULL, "typeAccount" "public"."users_typeaccount_enum" NOT NULL DEFAULT 'Anunciante', CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
